...
<div id="window">
	<div class='page_title'>
		...
		<form action="<?php echo U('Admin/Banner/edit');?>/id/<?php echo $data['id'];?>" method="post">
...
<div class="hd_uploadify_file_files uploadify_upload_files" input_file_id ="hd_uploadify_file">
    ...
    <div style="clear:both;"></div>
						...
						<img src="http://localhost/Lee/<?php echo $data['image'];?>"/>
					</td>
				</tr>
				<tr>
					<td>排序</td>
				...
				<tr>
					...
					<td>
						...
						<?php  }else{ ?>
							...
							<label>
							否
							<input type="radio" checked="true" name="isshow" value="0"/>
							</label>
						<?php }?>
