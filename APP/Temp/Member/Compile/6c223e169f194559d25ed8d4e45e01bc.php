...
<link href="http://localhost/Lee/APP/App/Member/Tpl/Public/css/login.css" rel="stylesheet" />
<link href="http://localhost/Lee/APP/App/Member/Tpl/Public/css/common.css" rel="stylesheet" />
<script type="text/javascript" src="http://localhost/Lee/APP/App/Member/Tpl/Public/js/login.js"></script>
</head>
	<body>
...
<div id="headNav" class="w1000 ">
	<ul id="nav-list" class="fs14">
		...
		<div id="main" class="wrap-wide">
			<div id="login" class="w1000">
				<div class="login-left">
					<div class="login-left-main">
						<h2 class="login-img">
							<img src="http://localhost/Lee/APP/App/Member/Tpl/Public/images/login-t.jpg">
						</h2>
					<form id="loginForm" action="<?php echo U('Member/Login/login');?>" method="post">
							<ul class="login-form">
								<li>
									...
									<span id="hd_username" style="margin-top:5px;"></span>

								</li>
								<li>
									<label>密码：</label>
									<input type="password" name="password">
									<span id="hd_password" style="margin-top:5px;"></span>

								</li>
								<li>
									<label>验证码：</label>
									<input url="<?php echo U('http://localhost/Lee/index.php/Member/Login/checkCode');?>" id="inputCode" type="text" class="grid-105" name="code" />
									<img  id="codeImg" width="80" height="33"  onclick="change.call(this);" src="<?php echo U('http://localhost/Lee/index.php/Member/Login/showCode');?>"/>
								...
								<li>
									<label>&nbsp;</label>
									<input class="check" name="remember" type="checkbox" value="1" />
								<div style="height:26px;;line-height: 26px;">记住用户名</div>
								</li>
								<li>
									<label>&nbsp;</label>
