		...
		<div id="main" class="wrap-wide">
			...
			<div id="content">
				<div class='collect-nav'>
					<a  id='1' href="<?php echo U('Member/Index/collect');?>" class='active'>全部</a>
					<a id='2' href="<?php echo U('Member/Index/collect');?>/status/0">未付款订单</a>
					<a id='3' href="<?php echo U('Member/Index/collect');?>/status/1">已付款订单</a>
				</div>
					...
					<ul>
						...
						<li class="goods-info">
							<ul>
								...
								<li class="rowCaozuo">
									<div class="clearfix bk20"></div>
									<?php if($nums['order_status']==0){?><a class='btn' href="<?php echo U('Member/Order/index');?>/order_id/<?php echo $nums['order_id'];?>">付款</a><?php }?>
									<a href="<?php echo U('Member/Index/del');?>/order_id/<?php echo $nums['order_id'];?>" class="delAffirm">删除</a>
								</li>
							</ul>
						</li>
						<?php }?><?php endif;?>
