...
<div class="hd_setup">
    ...
    <h2>
        <a href="http://localhost/11.11/Setup/index.php/Rbac/shownode">查看所有节点</a>
        <br/>
...
<form method="post" name="form1" id="form1" action="http://localhost/11.11/Setup/index.php/Rbac/addnode">
