...
<div class="hd_setup">
    ...
    <h2>
        <a href="http://localhost/11.11/Setup/index.php/Rbac/showuser" target="_self">查看用户列表</a>&nbsp;&nbsp;&nbsp;
        <a href="http://localhost/11.11/Setup/index.php/Rbac/showrole" target="_self">查看用户组(角色)</a>&nbsp;&nbsp;&nbsp;
        <br/>
...
<form method="post" name="form1" id="form1" action="http://localhost/11.11/Setup/index.php/Rbac/adduser">
...
<script type="text/javascript">
    $("#form1").submit(function(){
        ...
        if($("#username").val()==''){
            stat = false;
            $("#username").after("<span>用户名称不能为空</span>");
        }else if(!/^[a-z]\w+$/.test($("#username").val())){
             stat = false;
            $("#username").after("<span>用户名必须以字母开始</span>");
        }
