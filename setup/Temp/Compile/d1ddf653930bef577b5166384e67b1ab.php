...
<body>
    ...
    <div class="setup">
        <dl>
            <dt>RBAC表配置</dt>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/setconfig">配置RBAC表参数</a></dd>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/createrbactable">安装RBAC数据库表</a></dd>
        </dl>
        <?php if(C('RBAC_DB_SET')){?>
        <dl>
            <dt>RBAC用户&用户组设置</dt>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/showrole" >查看用户组</a></dd>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/addrole" >添加用户组</a></dd>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/showuser" >查看用户</a></dd>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/showadduser" >添加用户</a></dd>
        </dl>
        <dl>
            <dt>权限节点设置</dt>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/shownode" >查看节点信息</a></dd>
            <dd><a href="http://localhost/11.11/Setup/index.php/rbac/showaddnode" >添加权限节点</a></dd>
        </dl>
        <?php }?>
    </div>
